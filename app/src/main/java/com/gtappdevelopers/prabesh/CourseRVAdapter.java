...
public class CourseRVAdapter extends RecyclerView.Adapter<CourseRVAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CourseRVAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.coursera.setText(courseRVModal.getCoursera());
        holder.coursePriceTV.setText("Salary: " + courseRVModal.getCoursePrice());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView courseTV, coursePriceTV, coursera;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            coursera = itemView.findViewById(R.id.location);
        }
    }
    ...
    public void filterList(ArrayList<CourseRVModal> filterllist) {
        // below line is to add our filtered
        // list in our course array list.
        courseRVModalArrayList = filterllist;
