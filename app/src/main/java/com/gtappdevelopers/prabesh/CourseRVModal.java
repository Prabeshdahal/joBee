...
public class CourseRVModal implements Parcelable {
    ...
    public void setCoursera(String coursera){
        this.coursera = coursera;
    }
    public CourseRVModal() {}

    public CourseRVModal(String courseId, String courseName, String courseDescription, String coursePrice, String bestSuitedFor, String courseImg, String courseLink, String coursera) {
        this.courseName = courseName;
        this.courseId = courseId;
        this.courseDescription = courseDescription;
        this.coursePrice = coursePrice;
